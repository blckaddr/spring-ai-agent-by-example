 ...
 *
 * <p>The single-agent endpoints from earlier phases are untouched; this is a separate surface — the
 * chat lives at {@code /chat}, this planning graph at {@code /plan}, with a hub at {@code /}.
 */
@RestController
